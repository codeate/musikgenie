...
<!--<![endif]-->
<head>
	<title>Events | MusikGenie.com | Sharing Love through Music</title>
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
	<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
	<!-- Seo Meta -->
		<meta name="description" content="Events |  MusikGenie.com">
		<meta name="keywords" content="song deidcations, deidcate songs, Nigerian music events,Nigerian songs, latest songs, gists, nigeria news, nigerian artists, download songs, play songs online">
				...
				<div class="span3 sidebar">
					...
					<div class="def-block widget">
						<div class="widget-content">
							<a href="contact"><img src="images/advertbanner5.jpg" alt="Advertise"></a>
						</div><!-- widget content -->
					</div><!-- def block widget ADS -->
...
<?php
	...
	*/
	$query = "SELECT event_id  FROM $tbl_name";
	...
	/* Get data. */
	$sql = "SELECT * from events order by event_date   DESC LIMIT $start, $limit";
	...
	*/
	...
	{	
		...
		//previous button
		if ($page > 1) 
			$pagination.= "<li><a href=\"events/page$prev\" class=\"tbutton\"><span>Previous</span></a></li>";
		...
		{	
			for ($counter = 1; $counter <= $lastpage; $counter++)
			{
				if ($counter == $page)
					...
					$pagination.= "<li><a href=\"events/page$counter\" class=\"tbutton\"><span>$counter</span></a></li>";					
			}
		}
		elseif($lastpage > 5 + ($adjacents * 2))	//enough pages to hide some
		{
			...
			if($page < 1 + ($adjacents * 2))		
			{
				...
				$pagination.= "...";
				$pagination.= "<li><a href=\"events/page$lpm1\" class=\"tbutton\"><span>$lpm1</span></a></li>";
				$pagination.= "<li><a href=\"events/page$lastpage\" class=\"tbutton\"><span>$lastpage</span></a></li>";			
			}
			//in middle; hide some front and some back
			elseif($lastpage - ($adjacents * 2) > $page && $page > ($adjacents * 2))
			{
				$pagination.= "<li><a href=\"events/page1\" class=\"tbutton\"><span>1</span></a></li>";
				$pagination.= "<li><a href=\"events/page2\" class=\"tbutton\"><span>2</span></a></li>";
				$pagination.= "...";
			...
			else
			{
				...
				for ($counter = $lastpage - (2 + ($adjacents * 2)); $counter <= $lastpage; $counter++)
				{
					if ($counter == $page)
						...
						$pagination.= "<li><a href=\"events/page$counter\" class=\"tbutton\">$counter</a></li>";					
				}
			}
		}
		...
		//next button
		if ($page < $counter - 1) 
			$pagination.= "<li><a href=\"events/page$next\" class=\"tbutton\"><span>Next</span></a></li>";
		else
	 ...
	 if (mysql_num_rows($result) > 0)
		{
	  	while (list($event_id, $event_title, $event_date, $event_time, $event_venue, $event_city, $event_img, $event_details)=mysql_fetch_array($result))
			{	
						...
						<div class="post row-flui3d clearfix eventmini">
							<div class="featured_image_preview"><a href="events/event'.$event_id.'"><img src="'.$event_img.'" alt="'.$event_title.'"></a></div>
							<h3 class="post-title">  <a href="events/event'.$event_id.'">'.$event_title.'</a> </h3>
							...
							<div class="eventminilist"><span>Venue:</span><spann>'.$event_venue.'.</spann></div>
 							<hr/>
							 <div class="news_block_small">'.$event_details.'</div> 
							<a href="events/event'.$event_id.'" class="Rmore tbutton small"><span>Read More</span></a>
						</div><!-- post -->
							             	';
...
<!--End News Loop Plus Pagination -->
				...
				<div class="span3 sidebar">
					...
					<div class="def-block widget">
						<h4> Ads </h4><span class="liner"></span>
						<div class="widget-content tac">
							<a href="contact" title="Advertise Here"><img src="images/advert banner3.jpg" alt="Advertise"></a>
						</div><!-- widget content -->
					</div><!-- def block widget ads -->
