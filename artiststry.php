...
<?php 
							...
							include("rekua/konectam.php");
 							  	...
 							  	$query="SELECT DISTINCT   songs.* , artists.artist_name FROM songs INNER JOIN artists ON songs.artist_id = artists.artist_id order by songs.artist_id DESC  LIMIT 0,30";
