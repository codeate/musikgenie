...
if(isset($_POST['sendcontactmessage']))
{
	foreach (array_keys($_POST) as $key)
      ...
      $messagetosend = $_POST['message_to_send'];

    if (!preg_match("/\S+/",$fullname))
    {
      unset($_GET['do']);
      $errmessage = '<div class="alert alert-success fade in">
							    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
							    <strong class="site_color"><i class="icon-thumbs-down-alt"></i> Oops! </strong> What is your name? Enter your name so that we can contact you back.
					 </div>';
    ...
    if (!preg_match("/^\S+@[A-Za-z0-9_.-]+\.[A-Za-z]{2,6}$/",$senderemail))
    {
      ...
      $errmessage = '<div class="alert alert-success fade in">
							    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
							    <strong class="site_color"><i class="icon-thumbs-down-alt"></i> Sorry! </strong> Please enter your Valid Email Address.
							  </div>';
    ...
    if (!preg_match("/\S+/",$messagetosend))
    {
      ...
      $errmessage = '<div class="alert alert-success fade in">
							    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
							    <strong class="site_color"><i class="icon-thumbs-down-alt"></i> Sorry! </strong> Tell us Something. Fill the say Something form.
					 </div>';
 
    }
 
       $myemail = "info@musikgenie.com, victor.agidigbi@genieng.com, chinedu.obiukwu@genieng.com, chinedu.obiukwu@genieng.com";
       $emess = "  Name: ".$fullname."\n";
       ...
       if ($mailsend) 
       {
			    ...
			    mysql_query("INSERT INTO contact_us VALUES ('null', '$sendername', '$senderemail', '$messagetosend', '$date')"); 	
       }
			...
			<div class="row row-fluid clearfix mbf">
				<div class="span8 posts">
					...
					<div class="def-block clearfix">
						...
						<p>
						<strong>MusikGenie</strong> is Nigeria’s foremost global portal for lovers of music.<br/>
